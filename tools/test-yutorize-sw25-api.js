...
const fixture = {
  ...
  "fellow6-2Action": "グレートパリーで近接攻撃を行う",
  "fellow6-2Words": "「騎士として参ります」",
  "fellow6-2Num": "24",
  "fellow6-2Note": "K40+14＠12",
...
(async () => {
  ...
  assert.equal(
    ...
    [
      "### ■フェロー行動表",
      "1D6 フェロー行動表",
      "choice([補]悪意の針／[主]貫く光条／スカウト運動判定,[補]悪意の針／[主]貫く光条／スカウト運動判定,肉体修復,肉体修復,アースハンマー,リムチョッパー投擲／グレートパリーで近接攻撃を行う) フェロー行動表",
      "",
      "### ■フェロー行動宣言",
      "### 1,2：",
      ...
      "グレートパリーで近接攻撃を行う\\n「騎士として参ります」\\n達成値：24\\nK40+14＠12",
      "K40+14@12 ダメージ（グレートパリーで近接攻撃を行う）",
    ].join("\n"),
  );
